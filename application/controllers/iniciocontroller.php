		...
		if(!$logout){
			if (isset($_SESSION['USER-AD'])){
				if ($_SESSION['USER-AD']["user_rol"] == 0){
					...
					$dispatch = new TempController('Temp','temp','home',0);
					$dispatch->home();
				}elseif($_SESSION['USER-AD']["user_rol"] == 10){
					$this->_template = new Template('Void','render');
					$dispatch = new TempController('Temp','temp','home',0);
					$dispatch->home();
				}elseif($_SESSION['USER-AD']["user_rol"] == 11){
					$this->_template = new Template('Void','render');
					$dispatch = new TempController('Temp','temp','home',0);
					$dispatch->home();
				}elseif($_SESSION['USER-AD']["user_rol"] == 12){
					$this->_template = new Template('Void','render');
					$dispatch = new TempController('Temp','temp','home',0);
					$dispatch->home();
				}elseif($_SESSION['USER-AD']["user_rol"] == 13){
					$this->_template = new Template('Void','render');
					$dispatch = new TempController('Temp','temp','home',0);
					$dispatch->home();
				}elseif($_SESSION['USER-AD']["user_rol"] == 14){
					$this->_template = new Template('Void','render');
					$dispatch = new TempController('Temp','temp','home',0);
					$dispatch->home();
				}elseif($_SESSION['USER-AD']["user_rol"] == 15){
					$this->_template = new Template('Void','render');
					$dispatch = new TempController('Temp','temp','home',0);
					$dispatch->home();
				}else{
