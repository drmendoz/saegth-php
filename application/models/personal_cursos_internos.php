<?php
class Personal_cursos_internos extends Model {
	public $id;
	public $id_persona;
	public $titulo;
	public $area_estudio;
	...
	public static function select_all($id){
		$obj = new Personal_cursos_internos();
		return $obj->query_('SELECT * FROM `personal_cursos_internos` WHERE `id_persona`='. $id .'');
	}
