...
class Evaluacion_desempenio_pregunta extends Model{ 
// class : begin
...
// **********************
	...
	function select($id){
		$sql =  "SELECT * FROM evaluacion_desempenio_preguntas WHERE id = $id;";
	...
	function select_x_tema($id_tema){
		...
		$sql =  "SELECT id FROM evaluacion_desempenio_preguntas WHERE id_tema=$id_tema";
		$row = $this->query_($sql);
		$result = array();
	...
	function select_x_tema_($id_tema,$id_e=0, $activo=''){
		...
		$sql =  "SELECT * FROM evaluacion_desempenio_preguntas WHERE id_tema=$id_tema AND id_empresa=$id_e ";
		if($activo)
			$sql .= "AND activo = $activo ";
		return $this->query_($sql);
	}
	function select_x_tema__($id_tema,$id_e=0){
			$sql =  "SELECT * FROM evaluacion_desempenio_preguntas WHERE id_tema=$id_tema AND (id_empresa=$id_e OR id_empresa=0) AND activo = 1 ";
			// echo $sql;
			return $this->query_($sql);
	}
...
// **********************
	...
	function delete(){
		$sql = "DELETE FROM evaluacion_desempenio_preguntas WHERE id = $id;";
...
// **********************
	...
	function insert(){
		...
		$sql = "INSERT INTO evaluacion_desempenio_preguntas ( id,id_tema,id_empresa,pregunta,inverso,op_respuesta,activo ) VALUES ( '$this->id','$this->id_tema','$this->id_empresa','$this->pregunta','$this->inverso','$this->op_respuesta','$this->activo' )";
		$result = $this->query_($sql);
...
// **********************
	...
	function update(){
		...
		$sql = " UPDATE evaluacion_desempenio_preguntas SET  id = '$this->id',id_tema = '$this->id_tema',id_empresa = '$this->id_empresa',pregunta = '$this->pregunta',inverso = '$this->inverso',op_respuesta = '$this->op_respuesta',activo = '$this->activo' WHERE id = $this->id ";
	...
	{
		$sql = "UPDATE evaluacion_desempenio_preguntas SET activo = $this->activo WHERE id = $this->id ";

		$result = $this->query_($sql);
	}

	function activa_inactiva_preguntas(){
		$sql = "UPDATE evaluacion_desempenio_preguntas SET activo = $this->activo WHERE id_tema = $this->id_tema ";
