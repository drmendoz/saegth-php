<ul class="nav main-menu">
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu">
	  ...
	  <li><a href='<?php echo BASEURL ?>multifuente/reiniciar' >Reiniciar</a></li>
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      ?>
       <li><a href="<?php echo BASEURL ?>scorecard/vista_scorecard2" >Vista Scorecards</a></li>
      <li class="dropdown">
  ...
  <?php if ($permiso['evaluacion_desempenio']) { ?>
    <li class="dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href='<?php echo BASEURL ?>evaluacion_desempenio/competencias' >Crear Competencias</a></li>

      <li><a href='<?php echo BASEURL ?>evaluacion_desempenio/tema' >Crear Temas / Preguntas</a></li>

      <li><a href='<?php echo BASEURL ?>evaluacion_desempenio/cuestionario' >Crear Cuestionarios</a></li>

      <li><a href='<?php echo BASEURL ?>evaluacion_desempenio/definir' >Definir</a></li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a id="li_his" style="margin-left: 20px;" href='<?php echo BASEURL ?>evaluacion_desempenio/resultados' >Resultados de Encuestas</a></li>
  ...
  <li>
    ...
    <a href="#" class="denied">
      ...
      <span class="hidden-xs">Evaluaci&otilde;n de desepe&ntilde;o</span>
    ...
    <ul class="dropdown-menu">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a id="li_his" style="margin-left: 20px;" href='<?php echo BASEURL ?>user/tests/s_his' >Resultados de Encuestas</a></li>

          <li><a id="li_cres" style="margin-left: 20px;" href='<?php echo BASEURL ?>user/tests/s_cres' >Comparar Encuestas</a></li>

          <li><a id="li_seg" style="margin-left: 20px;" href='<?php echo BASEURL ?>sonda/segmentacion' >Comparar Criterios</a></li>

        </ul>
      
      </li>

      <li><a href='<?php echo BASEURL ?>sonda/grupos_criticos' >Grupos Cr&iacute;ticos</a></li>
	  
	  <li><a href='<?php echo BASEURL ?>sonda/enviar_recordatorio' >Estado del Proceso</a></li>
	  
	  <li><a href='<?php echo BASEURL ?>sonda/enviar_email_encuesta' >Enviar Email Encuesta</a></li>
  ...
  <li class="dropdown">
    ...
    <a id="a_efectividad" href="#" class="dropdown-toggle">

      <i class="fa fa-signal"></i>

      <span class="hidden-xs">Efectividad Organizacional</span>

    </a>

    <ul class="dropdown-menu">

      <li><a href='<?php echo BASEURL ?>efectividad_departamental/tema' >Crear Temas</a></li>

      <li><a href='<?php echo BASEURL ?>efectividad_departamental/clima_laboral' >Definir</a></li>

      <li class="dropdown">
        
        <a id="a_res_efect" href="#" class="dropdown-toggle">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a id="li_his_efect" style="margin-left: 20px;" href='<?php echo BASEURL ?>user/tests/e_his' >Resultados de Encuestas</a></li>

          <li><a id="li_cres_efect" style="margin-left: 20px;" href='<?php echo BASEURL ?>user/tests/e_cres' >Comparar Encuestas</a></li>

          <li><a id="li_seg_efect" style="margin-left: 20px;" href='<?php echo BASEURL ?>efectividad_departamental/segmentacion' >Comparar Criterios</a></li>

        </ul>
      
      </li>

      <li><a href='<?php echo BASEURL ?>efectividad_departamental/grupos_criticos' >Grupos Cr&iacute;ticos</a></li>
    
    <li><a href='<?php echo BASEURL ?>efectividad_departamental/enviar_recordatorio' >Estado del Proceso</a></li>
    
    <li><a href='<?php echo BASEURL ?>efectividad_departamental/enviar_email_encuesta' >Enviar Email Encuesta</a></li>
  ...
  <li class="dropdown">
    ...
    <a id="a_riesgo" href="#" class="dropdown-toggle">
    ...
    <ul class="dropdown-menu">
      ...
      <li>
        <!--<a href='<?php //echo BASEURL ?>riesgo_psicosocial/resultados' >Resultados</a>-->
        <a id="a_riesgo_res" href="#" class="dropdown-toggle">
        ...
        <li><a id="li_r_his" style="margin-left: 20px;" href='<?php echo BASEURL ?>riesgo_psicosocial/riesgo_historicos' >Resultados de Encuestas</a></li>

          <li><a id="li_r_cres" style="margin-left: 20px;" href='<?php echo BASEURL ?>riesgo_psicosocial/riesgo_comparar' >Comparar Encuestas</a></li>

          <li><a id="li_r_seg" style="margin-left: 20px;" href='<?php echo BASEURL ?>riesgo_psicosocial/riesgo_segmentacion' >Comparar Criterios</a></li>

        </ul>
      
      </li>

      <li><a href='<?php echo BASEURL ?>riesgo_psicosocial/grupos_criticos' >Grupos Cr&iacute;ticos</a></li>
