...
<div id="tema">
	...
	foreach ($res as $key => $value) {
		...
		echo "<a href='".BASEURL."efectividad_departamental/pregunta/".$value['id']."' class='text-upper'>".ucfirst($tema->htmlprnt($value['tema']))."</a>";
		echo "</h5>";
	}
	?>
</div>
