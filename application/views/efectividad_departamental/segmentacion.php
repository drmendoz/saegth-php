...
?>
<form action="<?php echo BASEURL.'efectividad_departamental/segmentacion' ?>" method="POST">
	...
	<table id="tableall" class="table table-bordered table-hover consulta" style="margin-top:50px">
		...
		<tbody>
			...
			foreach ($temas as $key => $value) {
				...
				echo "<td style='min-width:500px; max-width:500px; white-space:normal;'><h4><strong><a href='".BASEURL."efectividad_departamental/segmentacion_pregunta/".$tema_id."'>".$tema_nombre."</a></strong></h4>";
			...
			<tr>
				...
				<td class="text-center">
					<div class="btn-group">
						<a href="<?php echo BASEURL ?>efectividad_departamental/top_seg/<?php echo $sondas; ?>/<?php echo $arrDatos['campo']; ?>/<?php echo $arrDatos['id']; ?>/DESC" class="btn btn-default">Mejor puntaje</a>
						<a href="<?php echo BASEURL ?>efectividad_departamental/top_seg/<?php echo $sondas; ?>/<?php echo $arrDatos['campo']; ?>/<?php echo $arrDatos['id']; ?>/ASC" class="btn btn-default">Peor puntaje</a>
