...
?>
<form id="frmDefinir" class="form-horizontal" method="POST" action="<?php echo BASEURL ?>efectividad_departamental/def_preguntas">
  ...
  <div class="row">
      ...
      $temas = new Sonda_tema(); 
			$l_temas=$temas->select_all_efectividad();
