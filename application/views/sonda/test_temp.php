...
<form id="target" class="form" method="POST" action="<?php echo BASEURL ?>sonda/test_temp/<?php echo $id_e ?>/<?php echo $id_t ?>">
	...
	<h4 class="form-group">SONDA - Esta encuesta es absolutamente anónima y confidencial o sea, No interesa saber quien contestó de una u otra forma. lo que <strong>SI</strong> interesa es que sea <u>muy sincero</u> en sus respuestas.</h4>
	<?php
