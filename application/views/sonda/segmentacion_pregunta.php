		...
		<thead>
			<tr>
				<th rowspan="2">
					<h4>
						<strong>
							<a href="<?php echo BASEURL ?>sonda/segmentacion"><?php echo ucfirst($x->getTema()) ?>.-</a>
				...
				<?php
					...
					foreach ($arrCompara as $cont => $arrDatos) {
						...
						if($nuevos_criterios == 0)
							...
							$porcentajes_generales = $w->get_percent_x_pregunta_criterios($xxx,$ids,$preguntas_general);
