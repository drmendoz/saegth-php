...
<form id="frmDefinir" class="register" method="POST" enctype="multipart/form-data" action="<?php echo BASEURL ?>evaluacion_desempenio/definir">
	<div>
		<div class="tab-content" style="margin-top:15px">
			<div class="row form-group" id="seleccion">
				<div class="col-sm-4">
					<h4>ESCOGA A SUS EVALUADORES</h4>
				</div>
				
				<div class="col-sm-4">
					<input type="radio" id="seleccion_evaluadores" name="seleccion_evaluadores" value="S">
				  	<label for="male">Si</label>

				  	<input type="radio" id="seleccion_evaluadores" name="seleccion_evaluadores" value="N" checked>
			...
			<div class="row">
				...
				<div class="col-xs-4">
					<input id="objetivos_individuales" name="objetivos_individuales" type="checkbox" value="1">
				</div>
			</div>
			<div class="row">
				<label class="col-xxs-6 col-xs-4 col-sm-3 col-md-2 control-label">Cuestionario:</label>
				<div class="col-xs-4">
					<select class="form-control" name="id_cuestionario" id="id_cuestionario" required>
					<option value="">Escoga el cuestionario</option>
					<?php 
					$x = new Evaluacion_Desempenio_Cuestionario();
					$x->get_Cuestionarios_Combo();
					?>
					</select>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<textarea class="form-control" name="texto_encuesta" id="texto_encuesta" rows="10" cols="150">Es imprescindible que responda con absoluta sinceridad y que sus respuestas se basen exclusivamente en su propia experiencia.
La Escala de Calificación desde 1 a 5, siendo 1 la respuesta menos favorable y 5 la más favorable.
Su anonimato y confidencialidad de las respuestas están garantizadas a pesar de que la primera parte del cuestionario le pide indicar alguna información organizacional, lo cual cumple el exclusivo propósito de poder estratificar y segmentar los resultados según esos criterios demográficos y así ayudar a los clientes a tomar mejores acciones correctivas sobre su Evaluación de Desempeño.
Gracias anticipadas por su dedicación y confianza.</textarea>
				</div>
			</div>
		</div>
	</div>
