<?php
class Personal_cursos extends Model {
	public $id;
	public $id_persona;
	public $titulo;
	public $area_estudio;
	...
	public static function select_all($id){
		$obj = new Personal_cursos();
		return $obj->query_('SELECT * FROM `personal_cursos` WHERE `id_persona`='. $id .'');
	}
	...
	public function get_horas(){
		return $this->htmlprnt($this->horas);
	}
