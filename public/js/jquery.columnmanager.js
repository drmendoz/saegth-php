	...
	$.fn.columnManager = function(options)
	{
		...
		var createColumnHeaderList = function(table)
		{
			...
			if ( table.tHead && table.tHead.length )
			{
	            ...
	            //alert('si thead ' + table + ' ' + headRow);				
			}
			else if ( table.rows.length )
			{
				headRow = table.rows[0];
	            //alert('no thead ' + table + ' ' + headRow);				
			}
			else
			{
        ...
        return this.each(function() 
        {
			...
			for ( i = 0; i < rows.length; i++ )
			{
				...
				var cells = rows[i].cells;
			              ...
			              // alert(cells.length + ' columnas  y a procesar la columna ' + col);
			               /*
                           for ( var w = 0; w < cells.length; w++ ){
                           	   alert(cells[w].realIndex);
                           }
						   */
                         ...
                         if (i == 2){
                           var mensaje = '';
                           for ( var w = 0; w < cells.length; w++ ){
                           	   mensaje = mensaje + 'Fila ' + i + " : " + w + " - " + colsVisible[w] + '\n';
                           }
                           alert(mensaje);
						 } 
				...
				/*
                         if (i == 2){				
                           var mensaje = '';
                           for ( var w = 0; w < cells.length; w++ ){
                           	   mensaje = mensaje + ' Fila ' + i + " : " + w + " - " + prueba[w] + '\n';
                           }
                           alert(mensaje);
						 }
                 */ 						   							
